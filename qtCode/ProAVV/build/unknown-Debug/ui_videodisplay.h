...
public:
    ...
    void setupUi(QWidget *VideoDisplay)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 160, 369));
    ...
    {
        VideoDisplay->setWindowTitle(QCoreApplication::translate("VideoDisplay", "Form", nullptr));
    } // retranslateUi
