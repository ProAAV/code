/****************************************************************************
** Meta object code from reading C++ file 'aav_volumebutton.h'
**
...
#include "../../../../yyy/code/qtCode/ProAVV/aav_volumebutton.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'aav_volumebutton.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 5), // "sigEn"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 10), // "sloTimeOut"
QT_MOC_LITERAL(4, 31, 14) // "sloTimeOutStop"

    },
    "VolumeButton\0sigEn\0\0sloTimeOut\0"
    "sloTimeOutStop"
};
...
void VolumeButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigEn(); break;
        case 1: _t->sloTimeOut(); break;
        case 2: _t->sloTimeOutStop(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VolumeButton::sigEn)) {
                *result = 0;
                return;
            }
        }
